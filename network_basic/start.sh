...
docker-compose -f docker-compose.yml up -d ca.battery.com orderer.battery.com peer0.org1.battery.com couchdb cli
docker ps -a
...
#docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org1.battery.com/msp" peer0.org1.battery.com peer channel join -b battery.block
docker exec cli peer channel join -b battery.block